# karyo_RxRy
`karyo_RxRy` is a Python script for estimating karyotypic sex and detecting chromosomal aneuploidies from ancient DNA sequencing data.

The method uses chromosome-specific read count ratios, comparing reads mapping to chromosomes X, Y and optionally 21 against an autosomal baseline. It was developed for low-coverage ancient DNA data and applied in:

> Anastasiadou et al. 2024. Detection of chromosomal aneuploidy in ancient genomes. *Communications Biology*.
...
Use this tool when you have ancient DNA sequencing data and want to estimate chromosome X/Y dosage from mapped reads.

The method is intended for research use in ancient DNA and population genomics. It is not intended for clinical diagnosis.
...
This repository currently preserves the original implementation used for the associated publication. A future version may provide a Python 3-compatible implementation.
...
``` samtools view -q 30 bamfile.bam | python2 karyo_RxRy_script.py ``` 
...
``` samtools view -q 30 bamfile.bam | python2 karyo_RxRy_script.py --capture ``` 
### Chromosome 21 
...
``` samtools view -q 30 bamfile.bam | python2 karyo_RxRy_script.py --chr21 ```
...
Anastasiadou et al. 2024. Detection of chromosomal aneuploidy in ancient genomes. Communications Biology. https://doi.org/10.1038/s42003-023-05642-z

## License
This project is released under the MIT License. See LICENSE for details.

## Contacts
kyriaki.anastasiadou95@gmail.com / kyriaki.anastasiadou@crick.ac.uk  
